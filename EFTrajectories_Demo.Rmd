...
#source functions (change paths for your machine)
source("~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/OHBMEdlecture/Scripts/generalfuncs.OHBMdemo.R")
#load dataset 1 (change paths for your machine) 
load(file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/OHBMEdlecture/Data/Simdataset1_EF.Rdata")
```
...
```{r include=TRUE, message=F, warning=F}
#Dataset 2
load(file="~/Library/Mobile\ Documents/com~apple~CloudDocs/Projects/OHBMEdlecture/Data/Simdataset2_EF.Rdata")
